...
const getProducts = async (req, res, next) => {
    try {
        ...
        let serachQueryCondition = {}
        let select = {}
        if (searchQuery) {
            queryCondition = true
            serachQueryCondition = {$text: {$search: searchQuery}}
            select = {
        ...
        if (queryCondition) {
            query = {
                $and: [priceQueryCondition, ratingQueryCondition, categoryQueryCondition, serachQueryCondition, ...attrsQueryCondition]
            } 
        }
